...
$excel->setActiveSheetIndex(0)->setCellValue('A3', "PER $_SESSION[bln] $_SESSION[tahun]"); // Set kolom A1 dengan tulisan "DATA SISWA"
...
$sql = mysqli_query($koneksi, "SELECT ksp15.*, anggota.* FROM ksp15 INNER JOIN anggota ON ksp15.id_anggota=anggota.id_anggota  WHERE bulan = '$bln' AND tahun = '$tahun'");
...
header('Content-Disposition: attachment; filename="Rekapitulasi '.$bln.' '.$tahun.'.xlsx"'); // Set nama file excel nya
